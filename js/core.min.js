...
(function(f) {
    ...
    function z(a, c, b, d, e) {
        for (var h = {}, l = {}, f = {}, g = {}, m = {}, k = {}, r = null, q = 0; q < d.length; q++) {
            var p = d[q]
              ...
              , u = a / t[p]
              , v = c / t[p];
            e && (u = 0 < u ? Math.floor(u) : Math.ceil(u),
    ...
    function C(a) {
        for (var c = ["webkit", "moz"], b = 0; b < c.length && !a.requestAnimationFrame; ++b)
    ...
    g.prototype.addTime = function(a) {
        if (this.data.attributes.ref_date instanceof Date) {
            ...
            isNaN(this.data.attributes.ref_date) || (this.data.attributes.ref_date += 1E3 * a)
    }
    ;
    g.prototype.initialize = function(a) {
        ...
        var d = B();
        d || "undefined" === typeof G_vmlCanvasManager || (G_vmlCanvasManager.initElement(b),
        d = x = !0);
        ...
        for (e in this.data.text_elements)
            this.config.time[e].show && (a = f("<div>"),
            a.addClass("textDiv_" + e),
            a.css("top", Math.round(.35 * this.data.attributes.item_size)),
    ...
    g.prototype.update = function(a) {
        ...
        if (!this.config.count_past_zero && c > this.data.attributes.ref_date) {
            ...
            for (b in y)
                ...
                0 > r.indexOf(e) || (Math.floor(d.raw_time[e]) !== Math.floor(d.raw_old_time[e]) && this.notifyListeners(e, Math.floor(d.time[e]), Math.floor(c), "visible"),
                a || (this.data.text_elements[e].text(Math.floor(Math.abs(d.time[e]))),
                h = k * this.data.attributes.item_size + this.data.attributes.item_size / 2,
                l = this.data.attributes.item_size / 2,
                f = this.config.time[e].color,
                "smooth" === this.config.animation ? (null === n || x || (Math.floor(d.time[n]) > Math.floor(d.old_time[n]) ? (this.radialFade(h, l, f, 1, e),
                this.data.state.fading[e] = !0) : Math.floor(d.time[n]) < Math.floor(d.old_time[n]) && (this.radialFade(h, l, f, 0, e),
                this.data.state.fading[e] = !0)),
                this.data.state.fading[e] || this.drawArc(h, l, f, d.pct[e])) : this.animateArc(h, l, f, d.pct[e], d.old_pct[e], (new Date).getTime() + 200)),
                n = e,
                k++);
            if (!this.data.paused && !a) {
                ...
                "smooth" === this.config.animation ? this.data.animation_frame = m.requestAnimationFrame(p, q.element, q) : (a = c % 1 * 1E3,
                0 > a && (a = 1E3 + a),
    ...
    g.prototype.drawArc = function(a, c, b, d) {
        if (null !== this.data.attributes.context) {
            ...
            f = 2 * d * Math.PI;
            "Both" === this.config.direction ? (d = !1,
            e -= f / 2,
            f = e + f) : "Clockwise" === this.config.direction ? (d = !1,
            f = e + f) : (d = !0,
            f = e - f);
    ...
    g.prototype.start = function() {
        ...
        if ("string" === typeof a) {
            ...
            null !== b && 0 < b.length ? (b = a.split(" "),
            a = b[0].split("-"),
            b = b[1].split(":"),
            a = new Date(a[0],a[1] - 1,a[2],b[0],b[1],b[2])) : (b = Date.parse(a),
            isNaN(b) ? (b = Date.parse(a.replace(/-/g, "/").replace("T", " ")),
            a = isNaN(b) ? new Date : b) : a = b);
            c.ref_date = a
        } else
            "number" === typeof this.data.timer ? this.data.paused && (this.data.attributes.ref_date = (new Date).getTime() + 1E3 * this.data.timer) : (c = f(this.element).data("timer"),
            "undefined" === typeof c && (c = f(this.element).attr("data-timer")),
            "string" === typeof c && (c = parseFloat(c)),
            "number" === typeof c ? (this.data.timer = c,
            this.data.attributes.ref_date = (new Date).getTime() + 1E3 * c) : this.data.attributes.ref_date = this.config.ref_date);
        this.data.paused = !1;
    ...
    g.prototype.setOptions = function(a) {
        null === this.config && (this.default_options.ref_date = new Date,
    ...
    g.prototype.addListener = function(a, c, b) {
        "function" === typeof a && ("undefined" === typeof b && (b = "visible"),
...
!function(e, t) {
    ...
    function t(e) {
        ...
        a = 0,
        n = s.length; n > a && (o = s[a],
        -1 === o.search(/^(http|https|ftp):\/\//) && -1 !== o.search(":")); a++)
            t = o.indexOf(":"),
            i = o.substring(0, t),
            r = o.substring(t + 1),
            r || (r = void 0),
    ...
    function o(e) {
        ...
        t = r.length; t > i; i++)
            o = r[i],
            "left" === o ? s = "0%" : "right" === o ? s = "100%" : "top" === o ? n = "0%" : "bottom" === o ? n = "100%" : "center" === o ? 0 === i ? s = "50%" : n = "50%" : 0 === i ? s = o : n = o;
        return {
            x: s,
            y: n
        }
    ...
    r.prototype.init = function() {
        var t, r, n = this, p = n.path, c = p, u = "", d = n.$element, l = n.settings, g = o(l.position), f = l.posterType;
        ...
        d.prepend(r),
        "object" == typeof p ? (p.mp4 && (u += '<source src="' + p.mp4 + '.mp4" type="video/mp4">'),
        p.webm && (u += '<source src="' + p.webm + '.webm" type="video/webm">'),
        p.ogv && (u += '<source src="' + p.ogv + '.ogv" type="video/ogg">'),
        t = n.$video = e("<video>" + u + "</video>")) : t = n.$video = e('<video><source src="' + p + '.mp4" type="video/mp4"><source src="' + p + '.webm" type="video/webm"><source src="' + p + '.ogv" type="video/ogg"></video>');
        try {
            t.prop({
                autoplay: l.autoplay,
                loop: l.loop,
